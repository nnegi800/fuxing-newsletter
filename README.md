...
| Phase | Input | Output |
|---|---|---|
| **Phase 1** - Newsletter copy | `input_data_[month].txt` | `headline_summary_output.md` - headlines, summaries, categories |
...
Name the file `input_data_[month].txt` (e.g. `input_data_may.txt`). Full format spec in `CLAUDE.md`.
